document.addEventListener('DOMContentLoaded', () => {
    ...
    // FIXED IMAGE LINKS for your personal photos
    const galleryImages = [
        { src: "https://i.imgur.com/uG9FNdE.png", caption: "Every moment with you is my favorite 💕" },
        { src: "https://i.imgur.com/0P3tH3K.png", caption: "The perfect partner in crime 😊" },
        { src: "https://i.imgur.com/8qS1gXq.png", caption: "You make my world so colorful ✨" }
    ];
    ...
    const playlistSongs = [
        // FIXED IMAGE LINKS for the song art
        { title: "Kesariya", artist: "Arijit Singh", src: "https://files.catbox.moe/r9pltd.mp3", img: "https://i.imgur.com/uG9FNdE.png" },
        { title: "Maan Meri Jaan", artist: "King", src: "https://files.catbox.moe/quqfx4.mp3", img: "https://i.imgur.com/0P3tH3K.png" },
        { title: "Apna Bana Le", artist: "Arijit Singh", src: "https://files.catbox.moe/m5qdp0.mp3", img: "https://i.imgur.com/8qS1gXq.png" }
    ];
    ...
    function createGameItem(type) {
        ...
        // FIXED IMAGE LINKS for the game items
        item.innerHTML = `<img src="${type === 'heart' ? 'https://i.imgur.com/jV7VLKU.png' : 'https://i.imgur.com/7l4q0T5.png'}">`;
